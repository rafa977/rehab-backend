...
type MedicalTherapy struct {
	...
	MedicalTherapyTitle       string `bun:"medical_title,notnull" json:"medical_title" validate:"required"`
	MedicalTherapyDescription string `bun:"medical_description" json:"medical_description" `
